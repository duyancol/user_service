...
public class JwtService {
    ...
    public String generateToken(
        ...
        return Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 50000 * 180 ))
    ...
    public String generateToken1(Map<String, Object> extraClaims, UserDetails userDetails, String ip, String ua) {
        ...
        if (!extraClaims.containsKey("role")) {
            ...
            if (role != null) {
                ...
                System.out.println("⚠️ WARNING: Token đang được tạo ra mà không có role!");
            }
        }
        return Jwts
                .builder()
                ...
                .setSubject(userDetails.getUsername())
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 1000L * 60 * 180)) // 15 phút
